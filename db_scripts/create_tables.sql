...
CREATE TABLE raw.gkg_raw (
	...
	themes_enhanced varchar(20000) NULL,
	locations varchar(5000) NULL,
	locations_enhanced varchar(20000) NULL,
	persons varchar(5000) NULL,
	persons_enhanced varchar(20000) NULL,
	...
	social_video_embeds varchar(5000) NULL,
	quotations varchar(20000) NULL,
	all_names varchar(65000) NULL,
	amounts varchar(5000) NULL,
	translation_info varchar(20000) NULL,
	extras_xml text NULL,
	processed bool DEFAULT false NOT NULL,
	CONSTRAINT gkg_raw_pk PRIMARY KEY (record_uuid)
);